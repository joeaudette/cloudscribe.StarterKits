# Using SimpleContent with cloudscribe Core and Entity Framework Core - PostgreSQl
...
This sample uses [cloudscribe Core](https://github.com/joeaudette/cloudscribe) for user authentication and Entity Framework/PostgreSql storage for content and data.
